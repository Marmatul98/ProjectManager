        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentationPath = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectKeywordID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KeywordID = table.Column<int>(nullable: false),
                    ProjectID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectKeywords", x => x.ProjectKeywordID);
                    table.ForeignKey(
                        name: "FK_ProjectKeywords_Keywords_KeywordID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectKeywords_KeywordID",
